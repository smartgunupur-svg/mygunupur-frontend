...
const trustBadges = [
  { icon: Landmark, text: '100+ Services', color: 'text-blue-600' },
  { icon: Clock, text: '24x7 Support', color: 'text-blue-600' },
  { icon: Users, text: 'Trusted by Citizens', color: 'text-green-600' },
  { icon: MapPin, text: 'One Click Access', color: 'text-blue-600' }
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {trustBadges.map((badge, index) => (
              ...
              >
                <badge.icon className="w-10 h-10 text-blue-400" />
                <p className="text-white font-semibold">{badge.text}</p>
              </motion.div>
            ))}
          </div>
          <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-center gap-4">
            ...
            <div>
              <h4 className="text-white text-lg font-bold">Building a Better Gunupur</h4>
              <p className="text-blue-100 text-sm">Together for a smarter and stronger tomorrow.</p>
            </div>
          </div>
        </div>
      </div>
