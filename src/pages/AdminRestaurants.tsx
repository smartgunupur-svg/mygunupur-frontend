...
const AdminRestaurants: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-red-50 pb-32">
      <motion.header
        initial={{ y: -80 }}
        animate={{ y: 0 }}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium">{restaurants.length} restaurants</p>
              </div>
            </div>
          </div>
          <button
