...
const AdminEmergencyContacts: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ category: '', name: '', phone: '' });
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-emerald-50 pb-32">
      ...
      <div className="max-w-6xl mx-auto px-4 space-y-4 pt-6">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 bg-gradient-to-br from-red-600 to-orange-600 text-white font-bold rounded-2xl shadow-lg hover:shadow-xl transition-all"
        >
        ...
        {showForm && (
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-gradient-to-br from-red-600 to-orange-600 text-white font-bold rounded-xl"
              >
        ...
        {loading ? (
          ...
          >
            ...
            <h3 className="text-xl font-bold text-slate-800 mb-2">No Emergency Contacts Yet</h3>
            <p className="text-slate-500">Add emergency contacts to display</p>
          </motion.div>
        ) : (
