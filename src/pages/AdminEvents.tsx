...
import { ArrowLeft, Calendar, Plus, Edit, Trash2, LogOut } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-4 h-full flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-slate-800">Events & Festivals</h1>
                <p className="text-xs text-slate-500 font-medium">{events.length} events scheduled</p>
              </div>
            </div>
          </div>
          <button
